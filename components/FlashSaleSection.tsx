...
export default function FlashSaleSection({ promotion }: FlashSaleSectionProps) {
  ...
  return (
    <Card variant="outlined" padding="none" className="border-brand-black overflow-hidden">
      {/* Header */}
      <div className="bg-brand-black px-4 py-4 sm:px-6 sm:py-5">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-canvas rounded-subtle flex items-center justify-center">
              <Zap className="w-5 h-5 sm:w-6 sm:h-6 text-brand-black animate-pulse" />
            </div>
            <div>
      ...
      <div className="p-4">
                ...
                <div className="p-3">
                  ...
                  <div className="mb-3">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-caption font-semibold text-brand-black">
                        {stock} tersisa
                      </span>
                    </div>
                    <div className="h-1.5 bg-surface-2 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-brand-black transition-all duration-500 rounded-full"
        ...
        <div className="mt-4 text-center">
          <Link
            href="/promo"
            className="inline-flex items-center gap-2 text-body-sm font-semibold text-text-primary hover:text-brand-black transition-colors"
          >
            Lihat Semua Promo
