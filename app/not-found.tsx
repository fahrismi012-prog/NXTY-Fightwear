      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12 relative">
        ...
        <div className="max-w-md w-full text-center relative z-10 space-y-8">
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-brand-black blur-xl opacity-30 rounded-full"></div>
            <div className="relative w-24 h-24 mx-auto bg-brand-black rounded-full flex items-center justify-center border-4 border-[#0a0a0a]">
          ...
          {/* Error Title */}
          <div>
            <p className="text-[10px] font-black text-brand-black uppercase tracking-[0.3em] mb-2 font-mono">
              ERROR 404
            </p>
