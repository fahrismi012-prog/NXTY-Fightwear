...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-canvas text-text-primary flex flex-col">
      ...
      <div className="bg-brand-green text-text-primary overflow-hidden border-b-2 border-[#0a0a0a]">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12 relative">
        ...
        <div className="max-w-md w-full text-center relative z-10 space-y-8">
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-brand-green blur-xl opacity-30 rounded-full"></div>
            <div className="relative w-24 h-24 mx-auto bg-brand-green rounded-full flex items-center justify-center border-4 border-[#0a0a0a]">
          ...
          {/* Error Title */}
          <div>
            <p className="text-[10px] font-black text-brand-green uppercase tracking-[0.3em] mb-2 font-mono">
              ERROR 404
            </p>
          ...
          <div className="space-y-4">
            <Link
              href="/"
              className="group relative inline-flex items-center justify-center gap-3 w-full sm:w-auto px-8 py-4 bg-brand-green text-text-primary text-sm font-black uppercase tracking-[0.2em] border-4 border-[#0a0a0a] hover:bg-[#ef4444] hover:border-brand-green active:translate-x-1 active:translate-y-1 active:border-[#0a0a0a] transition-all min-h-[60px]"
            >
            ...
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 bg-surface-2 text-text-primary text-sm font-black uppercase tracking-[0.2em] border-4 border-[#0a0a0a] hover:bg-[#333333] active:translate-x-1 active:translate-y-1 active:border-[#0a0a0a] transition-all min-h-[60px]"
            >
          ...
          {/* Extra Info */}
          <div className="pt-8 border-t-4 border-brand-green">
      ...
      {/* Brutalist footer */}
      <footer className="border-t-4 border-brand-green bg-canvas">
