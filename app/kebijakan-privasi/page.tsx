      ...
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        <div className="space-y-6 text-body-sm text-text-secondary leading-relaxed">
          ...
          <div>
            ...
            <p>Anda berhak mengakses, memperbarui, atau meminta penghapusan data pribadi Anda. Hubungi kami di <a href="mailto:anxietyfightwear@gmail.com" className="text-brand-black hover:underline">anxietyfightwear@gmail.com</a> untuk permintaan terkait data.</p>
          </div>
          ...
          <div>
            ...
            <p>Jika ada pertanyaan tentang kebijakan privasi ini, hubungi kami di <a href="mailto:anxietyfightwear@gmail.com" className="text-brand-black hover:underline">anxietyfightwear@gmail.com</a>.</p>
          </div>
        </div>
