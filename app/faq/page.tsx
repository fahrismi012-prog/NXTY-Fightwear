  ...
  return (
    <div className="min-h-screen bg-canvas">
      <div className="max-w-2xl mx-auto px-4 py-10">
        <p className="text-caption font-semibold uppercase tracking-widest text-brand-black mb-2">Bantuan</p>
        ...
        <div className="bg-surface-1 border border-border-subtle rounded-card p-5 text-center mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              ...
              className="inline-flex items-center justify-center px-5 py-2.5 bg-brand-black text-text-primary text-body-sm font-semibold rounded-subtle hover:bg-brand-black-hover transition-colors"
            >
              Email Kami
            </a>
            <a
              ...
              className="inline-flex items-center justify-center px-5 py-2.5 border border-border-default text-text-secondary text-body-sm font-semibold rounded-subtle hover:border-brand-black hover:text-brand-black transition-colors"
            >
              WhatsApp
            </a>
          </div>
